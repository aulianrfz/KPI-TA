...
<style>
    ...
    .form-page-title-container {
        display: flex;
        align-items: center;
        margin-bottom: 1.5rem; /* Adjusted from 2rem to better fit typical spacing */
    }
    .form-page-title {
        color: #3A3B7B; /* Warna biru tua/ungu, konsisten dengan halaman sebelumnya */
        font-weight: 600;
        font-size: 1.75rem; /* Ukuran judul utama */
        margin-bottom: 0; /* Hapus margin bawah default dari h2 */
    }
    .btn-back-icon {
        font-size: 1.25rem; /* Ukuran ikon kembali */
        color: #6c757d; /* Warna abu-abu standar untuk ikon */
    }
    .btn-back-icon:hover {
        color: #3A3B7B; /* Warna hover konsisten dengan judul */
    }
    ...
    .form-card {
        ...
        margin-bottom: 2rem; /* Margin bawah untuk card */
    }
    ...
    .form-label-styled {
        ...
        color: #495057; /* Warna label sedikit lebih gelap */
    }
    .form-control-custom-bg,
    .form-select-custom-bg { /* Tambahkan untuk select juga */
        background-color: #f8f9fa; /* Latar abu-abu muda untuk input/select */
        border: 1px solid #e9ecef; /* Border tipis */
        border-radius: 0.375rem; /* Bootstrap's default form-control radius */
    }
    .form-control-custom-bg:focus,
    .form-select-custom-bg:focus {
        background-color: #ffffff;
        border-color: #86b7fe; /* Warna border fokus Bootstrap */
        box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25); /* Shadow fokus Bootstrap */
    }
    textarea.form-control-custom-bg { /* Pastikan textarea juga mendapat style */
        min-height: 100px; /* Tinggi minimal untuk textarea */
    }

    /* Warning Text */
    .warning-text {
        color: #dc3545; /* Merah untuk teks peringatan */
        font-size: 0.875em; /* Ukuran font lebih kecil */
        margin-top: 0.5rem; /* Margin atas untuk teks peringatan */
    }
    ...
    .form-actions { /* Wrapper untuk tombol form */
        margin-top: 2rem;
    ...
    .modal-overlay-custom {
        ...
        align-items: center;
        z-index: 1055; /* Di atas elemen lain, di bawah modal Bootstrap jika ada */
    }
    ...
    .modal-content-custom .btn {
        margin: 0.5rem;
        min-width: 100px; /* Lebar minimal tombol modal */
    }
    .modal-content-custom .btn-primary { /* Bootstrap primary color */
    ...
    .modal-content-custom .btn-secondary { /* Bootstrap secondary color */
    ...
    .remove-dynamic-field:hover {
        color: #bb2d3b; /* Merah lebih gelap saat hover */
    }
    .dynamic-field-group { /* Untuk .peserta-group dan .tim-group */
        position: relative;
        /* max-width: 100%; Dihapus agar mengambil lebar penuh dari kolomnya */
    }
    .dynamic-field-group .form-select-custom-bg, /* Terapkan style ke select di dalam grup ini */
    .dynamic-field-group .form-control-custom-bg {
        padding-right: 35px; /* Ruang untuk tombol hapus */
    }
</style>
...
<div class="container">
    ...
    <div class="form-page-title-container">
        ...
        <a href="{{ route('jadwal.detail', ['id' => $jadwal->id]) }}" class="btn btn-link p-0 me-3" title="Kembali ke Detail Jadwal">
    ...
    <div id="errorModalCustom" class="modal-overlay-custom" style="display: flex;"> {{-- Langsung tampil jika ada session --}}
        <div class="modal-content-custom">
            ...
            <form method="POST" action="{{ route('jadwal.update', $agenda->id) }}">
                ...
                <input type="hidden" name="tanggal_dropdown" value="{{ old('tanggal_dropdown', $agenda->tanggal == old('tanggal_dropdown', $agenda->tanggal) && !old('lainnya') ? $agenda->tanggal : (old('lainnya') ? 'lainnya' : '') ) }}">
                ...
                <button type="button" onclick="document.getElementById('errorModalCustom').style.display = 'none';" class="btn btn-secondary">Batal</button>
            </form>
        </div>
    </div>
    @endif
    ...
    <div class="form-card">
        <form action="{{ route('jadwal.update', $agenda->id) }}" method="POST">
            ...
            <p class="mb-3">
                <small class="text-muted">Mengedit entri untuk jadwal: <strong>{{ $jadwal->nama_jadwal }}</strong> (Versi {{ $jadwal->version }}, Tahun {{ $jadwal->tahun }})
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="mata_lomba_id" id="mata_lomba_id" class="form-select form-select-custom-bg @error('mata_lomba_id') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="kegiatan" id="kegiatan" class="form-control form-control-custom-bg @error('kegiatan') is-invalid @enderror" value="{{ old('kegiatan', $agenda->kegiatan) }}" placeholder="Nama Kegiatan">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" name="waktu_mulai" id="waktu_mulai" class="form-control form-control-custom-bg @error('waktu_mulai') is-invalid @enderror" required value="{{ old('waktu_mulai', $agenda->waktu_mulai) }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" name="waktu_selesai" id="waktu_selesai" class="form-control form-control-custom-bg @error('waktu_selesai') is-invalid @enderror" required value="{{ old('waktu_selesai', $agenda->waktu_selesai) }}">
            ...
            <div class="mb-3">
                ...
                <select name="tanggal_dropdown" id="tanggal_dropdown" class="form-select form-select-custom-bg @error('tanggal') is-invalid @enderror @error('tanggal_dropdown') is-invalid @enderror" onchange="toggleCustomDate(this.value)">
                ...
                <input type="date" name="tanggal" id="customDate" class="form-control form-control-custom-bg mt-2 @error('tanggal') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <select name="venue_id" id="venue_id" class="form-select form-select-custom-bg @error('venue_id') is-invalid @enderror">
                    ...
                    @if(count($old_peserta) > 0)
                        @foreach($old_peserta as $index => $pesertaId)
                            <div class="dynamic-field-group mb-2">
                                ...
                                @if($index > 0 || count($old_peserta) > 1) {{-- Tombol hapus hanya jika bukan yang pertama ATAU ada lebih dari 1 --}}
            ...
            <div class="mb-3">
                ...
                <select name="juri_id" id="juri_id" class="form-select form-select-custom-bg @error('juri_id') is-invalid @enderror">
            ...
            <div class="form-actions">
                 {{-- Menggunakan $jadwal->id untuk route jadwal.detail --}}
                <a href="{{ route('jadwal.detail', ['id' => $jadwal->id]) }}" class="btn btn-custom-cancel me-2">Batal</a>
