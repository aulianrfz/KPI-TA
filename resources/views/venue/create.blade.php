    ...
    <div class="form-card">
        <form action="{{ route('venue.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control form-control-custom-bg @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Masukkan nama venue" required>
                @error('name')
