...
@section('content')
    ...
    <div class="row g-4 justify-content-center">
        ...
        {{-- card transaksi --}}
        <div class="col-md-4">
            <a href="{{ url('/rek-pembayaran') }}" class="text-decoration-none">
                <div class="card custom-card bg-gradient-transaksi text-white h-100">
                    <div class="card-body text-center">
                        <i class="bi bi-cash-stack display-5 mb-3"></i>
                        <h5 class="card-title fw-semibold">Rekening Pembayaran</h5>
                        <p class="card-text">Kelola rekening pembayaran</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-4">
            <a href="{{ url('/links') }}" class="text-decoration-none">
