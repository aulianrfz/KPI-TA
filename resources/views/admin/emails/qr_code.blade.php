...
<body>
    <div class="container">
        ...
        @if ($kategori)
            <p><strong>Nama Lomba:</strong> {{ $nama_utama }}</p>
            <p><strong>Kategori:</strong> {{ $kategori }}</p>
        @else
            <p><strong>Nama Event:</strong> {{ $nama_utama }}</p>
        @endif

        <div class="qr-note">
            Selamat! Anda telah berhasil terdaftar. QR Code Anda telah dikirim di email ini. Silakan unduh dan tunjukkan
