...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold" data-aos="zoom-in" style="color: #0367A6;">Pilih Event untuk Verifikasi Transaksi</h4>
    </div>

    <div class="row">
        @foreach($events as $event)
            <div class="col-md-4 mb-4" data-aos="zoom-in-down" data-aos-delay="100">
                <a href="{{ route('transaksi.by-event', $event->id) }}" class="text-decoration-none">
